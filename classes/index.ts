...
class BlogPost implements showTitle {
    ...
    constructor(_nomeDoSite: string) {
...
class SegundoPost implements showTitle {
    nameDoSite2

    constructor(_segudoNome: string) {
...
// Private
class ClassePrivada {
    private name = "Gabriel Jaune Ribera"

    metodoPrivada() {
        return this.name
    }

    private metodoPrivadaTeste() {
...
class StaticMembers2 {
    static prop2 = "Teste static2"      // Agora sim
    static metodo() {
...
class Item<T, U> {
    ...
    constructor(_primeiro: T, _segundo: U) {
...
const doguinho: Cachorro = new Gato();
